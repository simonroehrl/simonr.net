...
\begin{center}
  ...
  \;\textbar\; \href{mailto:simon.roehrl@oth-regensburg.de}{simon.roehrl@oth-regensburg.de}
...
\cventry{08/2023 -- present}{%
  \textbf{Co-founder \& Managing Director}, RSites GmbH, Teublitz (\href{https://rsites.net}{rsites.net})
  \begin{itemize}
...
\begin{itemize}
  ...
  \item Volunteering: Kolpingsfamilie Teublitz since 2019 --- organises and runs events for Kolping Kids (children aged 2--14). Active footballer (club team).
