...
\setlist[itemize]{leftmargin=1.1em,itemsep=1pt,parsep=0pt,topsep=1pt,label=--}
...
\begin{center}
  ...
  Am Herrnberg 5, 93158 Teublitz, Germany \;\textbar\; Born 11 January 2001\\[2pt]
  \href{mailto:simon.roehrl01@gmail.com}{simon.roehrl01@gmail.com}
...
\cventry{08/2023 -- present}{%
  \textbf{Founder}, RSites GmbH, Teublitz (\href{https://www.northdata.de/RSites+GmbH,+Teublitz/Amtsgericht+Amberg+HRB+7593}{Northdata})
  \begin{itemize}
    \item Corporate websites built accessibility-first (European Accessibility Act ready); 30+ websites delivered overall.
    \item Recent frontends with agency partner Gessulat + Gessulat: \href{https://karriere.suzuki.de/}{Suzuki} (corporate \& careers), Lürssen, \href{https://www.lkqkarriere.de/}{LKQ Europe}, \href{https://www.teledata.de/}{Teledata} redesign, \href{https://www.wurzer-umwelt.de/}{Wurzer}/\href{https://www.wumas.de/}{Wumas}, Servero, VDW; other brands incl.\ IG Metall (BMW, Siemens).
...
\cventry{10/2023 -- 03/2025}{%
  \textbf{Research Associate, project HASKI}, OTH Regensburg
  \begin{itemize}
...
\begin{itemize}
  \item Initiated and chairs the METR workshop (Metrics in Eye Tracking Research, \href{https://metr2026.com}{metr2026.com}) at ETRA 2026, Marrakech, Morocco --- the leading eye-tracking conference: own initiative from concept to programme, 7 workshop papers, own peer-review process, programme committee lead; community of $\sim$68 researchers forming a working group on metric standardisation.
...
\begin{itemize}
  \item \textbf{BlitzFrames} (\href{https://blitzframes.com}{blitzframes.com}, live, paying customers) --- accelerated video rendering for Remotion Lambda on a dedicated server fleet: up to 11$\times$ faster and 5$\times$ cheaper than stock, billed per frame.
  ...
  \item \textbf{\href{https://ecb-rates.com}{ecb-rates.com}} --- derives expected ECB rate paths from futures pricing (work in progress).
